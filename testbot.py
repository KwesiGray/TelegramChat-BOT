...
TOKEN: Final = '7170598307:AAFv0AP0v27jazsuUMH7TkSTqanzPgJolKo'
BOT_USERNAME : Final = '@UMAT_TARKWA_bot'

#Commands
async def start_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("Hello!! Welcome To The UMAT Admission Assistant Bot. Type the /help Command For Assistance")
...
/content-> The Actual Content of UMAT
    
/faculties-> Name of Faculties(Tarkwa)
    
/courses-> Available Courses(Tarkwa)

/halls-> Available Halls of Residence(Tarkwa)
...
async def content_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text("A Telegram Bot To help Assist Freshers on Their Admissions To U.M.A.T. Type /help to Navigate Through This ChatBot")
...
# Sentence Examples - [What halls are available, What courses are available, What are the faculties, What are the eligibility criteria, What is the contact information, What is the website link]
# Response Examples - [K.T Hall & Chambers Of Mines Hall (CMH) & Gold Refinery Hall (GRH), (Computer Science & Engineering) & (Mechanical Engineering) & (Mining Engineering)& (Environmental & Saftey Engineering), FOE, FMMT, SPET, FGES, Agg: 12, Agg: 08, Agg: 06, Hot line: +233 3121 97734]
